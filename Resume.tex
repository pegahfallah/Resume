...
\begin{itemize}
    \item{Executed CRM strategies for the MMI website and Costa Coffee loyalty app, increasing push notification and email click-through rates by 20\%.}
    ...
    \item{Designed two \textbf{Power BI dashboards} to analyze customer spending trends and Meta campaign performance, enabling data-driven decisions.}
    \end{itemize}
\resumeItemListEnd
