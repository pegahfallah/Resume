...
\resumeSubheading
  ...
  {Innovation Associate}{Dubai, UAE}
\resumeItemListStart
\resumeItem{Selected out of 12000 applicants for the Dubai Business Associates programme, a prestigious leadership and professional development initiative run under the patronage of His Highness Sheikh Mohammed bin Rashid Al Maktoum.}
\resumeItem{\textbf{Emirates Leisure Retail/MMI Placement}}
\begin{itemize}
    ...
    \item{Engineered a \textbf{data pipeline} to streamline the integration of CRM data, improving data accessibility for KPI tracking.}
